...
public:
    ...
    ///
//    Q_PROPERTY (int minPow           READ getMinPow             WRITE setMinPow)
    /// Maximum indicated value.

    Q_PROPERTY (double minPow           READ getMinimum             WRITE setMinimum)
    /// Maximum indicated value.
...
//	 void setMinPow (const int value);                       ///< Access function for #minimum - refer to #minimum property for details
//    double getMinPow () const;                                 ///< Access function for #minimum - refer to #minimum property for details
