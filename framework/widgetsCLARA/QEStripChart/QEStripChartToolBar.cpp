...
static const struct QEStripChartPushButtonSpecifications buttonSpecs [NUMBER_OF_BUTTONS] = {
   ...
   { 8,   ICW, 0, false, QString ("N"),                     QString ("Normalised Scale"),             SLOT (normalisedYScaleClicked (bool)) },
   { 0,   ICW, 0, false, QString ("R"),                     QString ("Raw Scale"),                    SLOT (rawYScaleClicked (bool))        },
...
void QEStripChartToolBar::rawYScaleClicked (bool)
{
   emit this->yRangeSelected (QEStripChartNames::reset);
}
