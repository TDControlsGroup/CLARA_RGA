...
#define DEBUG qDebug () << "QEArchiverInterfaceJSON:" << __FUNCTION__  << ":" << __LINE__


//------------------------------------------------------------------------------
//
QEArchiverInterfaceJSON::QEArchiverInterfaceJSON (QUrl url, QObject *parent) : QObject (parent)
{
...
//------------------------------------------------------------------------------
//
QEArchiverInterfaceJSON::~QEArchiverInterfaceJSON ()
{
...
//------------------------------------------------------------------------------
//
void QEArchiverInterfaceJSON::registerMetaTypes ()
{
   qRegisterMetaType<QEArchiverInterfaceJSON::ArchiveList> ("QEArchiverInterfaceJSON::ArchiveList");
   qRegisterMetaType<QEArchiverInterfaceJSON::PVNameList> ("QEArchiverInterfaceJSON::PVNameList");
   qRegisterMetaType<QEArchiverInterfaceJSON::ResponseValueList> ("QEArchiverInterfaceJSON::ResponseValueList");
   qRegisterMetaType<QEArchiverInterfaceJSON::Context> ("QEArchiverInterfaceJSON::Context");
}


//------------------------------------------------------------------------------
//
void QEArchiverInterfaceJSON::setUrl (QUrl url)
{
   this->mUrl = url;
...
//------------------------------------------------------------------------------
//
QUrl QEArchiverInterfaceJSON::getUrl ()
{
   return this->mUrl;
}
...
//------------------------------------------------------------------------------
//
QString QEArchiverInterfaceJSON::getName ()
{
...
//------------------------------------------------------------------------------
//
void QEArchiverInterfaceJSON::infoRequest (QObject *userData)
{
...
//------------------------------------------------------------------------------
//
void QEArchiverInterfaceJSON::archivesRequest (QObject *userData)
{
   QEArchiverInterfaceJSONAgent *agent;
   Context context;
   QVariantList args;
   ...
   agent = new QEArchiverInterfaceJSONAgent (this->client, this);
...
//------------------------------------------------------------------------------
//
void QEArchiverInterfaceJSON::namesRequest (QObject *userData, const int key, QString pattern)
{
   QEArchiverInterfaceJSONAgent *agent;
   Context context;
   QVariantList args;
...
//------------------------------------------------------------------------------
//
void QEArchiverInterfaceJSON::valuesRequest (QObject *userData,
                                         const int key,
...
//------------------------------------------------------------------------------
//
void QEArchiverInterfaceJSON::processInfo (const QObject *userData, const QVariant & response)
{
...
//------------------------------------------------------------------------------
//
void QEArchiverInterfaceJSON::processArchives (const QObject *userData, const QVariant & response)
{
...
//------------------------------------------------------------------------------
//
void QEArchiverInterfaceJSON::processPvNames  (const QObject *userData, const QVariant & response)
{
   PVNameList PvNames;
   QVariantList list;
   QVariant element;
...
//------------------------------------------------------------------------------
//
void  QEArchiverInterfaceJSON::processOnePoint (const DataType dtype,
...
//------------------------------------------------------------------------------
//
void QEArchiverInterfaceJSON::processOnePV (const StringToVariantMaps& map,
                                       const unsigned int requested_element,
...
//------------------------------------------------------------------------------
//
void QEArchiverInterfaceJSON::processValues (const QObject* userData,
...
//------------------------------------------------------------------------------
//
QString QEArchiverInterfaceJSON::alarmSeverityName (enum archiveAlarmSeverity severity)
{
   QString result;
...
//------------------------------------------------------------------------------
//
QCaDateTime QEArchiverInterfaceJSON::convertArchiveToEpics (const int seconds, const int nanoSecs)
{
...
//------------------------------------------------------------------------------
//
void  QEArchiverInterfaceJSON::convertEpicsToArchive (const QCaDateTime& datetime, int& seconds, int& nanoSecs)
{
