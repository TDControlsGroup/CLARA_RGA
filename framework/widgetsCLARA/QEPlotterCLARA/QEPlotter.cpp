...
static const QString item_labels [1 + NUMBER_OF_PLOTS] = {
   QString ("X"),
   QString ("RGA1"), QString ("RGA2"), QString ("RGA3"), QString ("RGA4"),
   QString ("USER1"), QString ("USER2"), QString ("G"), QString ("H"),
...
//      this->plotArea->setCurveStyle (QwtPlotCurve::Lines); 
      this->plotArea->setCurveStyle (QwtPlotCurve::Steps);
