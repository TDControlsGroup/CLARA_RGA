...
public:
    ...
    void setupUi(QGroupBox *RgaStatus)
    {
        ...
        Filament = new QGroupBox(RgaStatus);
        Filament->setObjectName(QStringLiteral("Filament"));
        Filament->setGeometry(QRect(0, 20, 181, 111));
        LEDFAIL = new QEBitStatus(Filament);
        ...
        label_6 = new QLabel(Filament);
        label_6->setObjectName(QStringLiteral("label_6"));
        label_6->setGeometry(QRect(160, 10, 16, 21));
        QFont font;
        font.setPointSize(6);
        label_6->setFont(font);
        LEDFIL = new QEBitStatus(Filament);
        ...
        label_3 = new QLabel(Filament);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(120, 10, 41, 21));
        label_3->setFont(font);
        LEDCOOL = new QEBitStatus(Filament);
        ...
        FILOFF = new QEPushButton(Filament);
    ...
    void retranslateUi(QGroupBox *RgaStatus)
    {
        ...
        Filament->setTitle(QApplication::translate("RgaStatus", "Filament Status", 0));
        ...
        Mult->setTitle(QApplication::translate("RgaStatus", "Faraday/Mult: status and calibration", 0));
        ...
        Mode->setTitle(QApplication::translate("RgaStatus", "Mode", 0));
