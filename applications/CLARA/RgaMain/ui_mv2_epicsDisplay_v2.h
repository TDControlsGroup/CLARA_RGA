...
public:
    ...
    void setupUi(QMainWindow *mainWindow)
    {
        ...
        charts->setGeometry(QRect(310, 10, 401, 171));
        ...
        barstrip1 = new QEPushButton(charts);
        barstrip1->setObjectName(QStringLiteral("barstrip1"));
        barstrip1->setGeometry(QRect(190, 30, 61, 20));
        ...
        IdSerial->setGeometry(QRect(20, 10, 271, 171));
        id_3 = new QLabel(IdSerial);
        id_3->setObjectName(QStringLiteral("id_3"));
        id_3->setGeometry(QRect(20, 70, 91, 21));
        id_4 = new QLabel(IdSerial);
        id_4->setObjectName(QStringLiteral("id_4"));
        id_4->setGeometry(QRect(20, 90, 91, 21));
        id_6 = new QLabel(IdSerial);
        id_6->setObjectName(QStringLiteral("id_6"));
        id_6->setGeometry(QRect(20, 130, 91, 21));
        id_1 = new QLabel(IdSerial);
        id_1->setObjectName(QStringLiteral("id_1"));
        id_1->setGeometry(QRect(20, 30, 91, 21));
        id_2 = new QLabel(IdSerial);
        id_2->setObjectName(QStringLiteral("id_2"));
        id_2->setGeometry(QRect(20, 50, 91, 21));
        id_5 = new QLabel(IdSerial);
        id_5->setObjectName(QStringLiteral("id_5"));
        id_5->setGeometry(QRect(20, 110, 91, 21));
        sn_3 = new QLabel(IdSerial);
        sn_3->setObjectName(QStringLiteral("sn_3"));
        sn_3->setGeometry(QRect(130, 70, 121, 21));
        sn_4 = new QLabel(IdSerial);
        sn_4->setObjectName(QStringLiteral("sn_4"));
        sn_4->setGeometry(QRect(130, 90, 121, 21));
        sn_6 = new QLabel(IdSerial);
        sn_6->setObjectName(QStringLiteral("sn_6"));
        sn_6->setGeometry(QRect(130, 130, 121, 21));
        sn_1 = new QLabel(IdSerial);
        sn_1->setObjectName(QStringLiteral("sn_1"));
        sn_1->setGeometry(QRect(130, 30, 121, 21));
        sn_2 = new QLabel(IdSerial);
        sn_2->setObjectName(QStringLiteral("sn_2"));
        sn_2->setGeometry(QRect(130, 50, 121, 21));
        sn_5 = new QLabel(IdSerial);
        sn_5->setObjectName(QStringLiteral("sn_5"));
        sn_5->setGeometry(QRect(130, 110, 121, 21));
    ...
    void retranslateUi(QMainWindow *mainWindow)
    {
        ...
        IdSerial->setTitle(QApplication::translate("mainWindow", "Device info", 0));
        id_3->setText(QApplication::translate("mainWindow", "Name", 0));
        id_4->setText(QApplication::translate("mainWindow", "Name", 0));
        id_6->setText(QApplication::translate("mainWindow", "Name", 0));
        id_1->setText(QApplication::translate("mainWindow", "Name", 0));
        id_2->setText(QApplication::translate("mainWindow", "Name", 0));
        id_5->setText(QApplication::translate("mainWindow", "Name", 0));
        sn_3->setText(QApplication::translate("mainWindow", "Name", 0));
        sn_4->setText(QApplication::translate("mainWindow", "Name", 0));
        sn_6->setText(QApplication::translate("mainWindow", "Name", 0));
        sn_1->setText(QApplication::translate("mainWindow", "Name", 0));
        sn_2->setText(QApplication::translate("mainWindow", "Name", 0));
        sn_5->setText(QApplication::translate("mainWindow", "Name", 0));
