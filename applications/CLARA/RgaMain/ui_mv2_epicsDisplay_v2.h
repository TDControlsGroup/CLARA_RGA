...
public:
    ...
    void setupUi(QMainWindow *mainWindow)
    {
        ...
        sn_1->setGeometry(QRect(160, 40, 101, 16));
        sn_4 = new QELabel(IdSerial);
        sn_4->setObjectName(QStringLiteral("sn_4"));
        sn_4->setGeometry(QRect(160, 100, 101, 16));
        sn_6 = new QELabel(IdSerial);
        sn_6->setObjectName(QStringLiteral("sn_6"));
        sn_6->setGeometry(QRect(160, 140, 101, 16));
        sn_2 = new QELabel(IdSerial);
        sn_2->setObjectName(QStringLiteral("sn_2"));
        sn_2->setGeometry(QRect(160, 60, 101, 16));
        sn_3 = new QELabel(IdSerial);
        sn_3->setObjectName(QStringLiteral("sn_3"));
        sn_3->setGeometry(QRect(160, 80, 101, 16));
        summary5 = new QEPushButton(IdSerial);
        summary5->setObjectName(QStringLiteral("summary5"));
        summary5->setGeometry(QRect(390, 120, 61, 20));
        summary5->setCheckable(false);
        summary1 = new QEPushButton(IdSerial);
        summary1->setObjectName(QStringLiteral("summary1"));
        summary1->setGeometry(QRect(390, 40, 61, 20));
        summary1->setCheckable(false);
        summary3 = new QEPushButton(IdSerial);
        summary3->setObjectName(QStringLiteral("summary3"));
        summary3->setGeometry(QRect(390, 80, 61, 20));
        summary3->setCheckable(false);
        barstrip6 = new QEPushButton(IdSerial);
        barstrip6->setObjectName(QStringLiteral("barstrip6"));
        barstrip6->setGeometry(QRect(460, 140, 61, 20));
        barstrip6->setCheckable(false);
        barstrip2 = new QEPushButton(IdSerial);
        barstrip2->setObjectName(QStringLiteral("barstrip2"));
        barstrip2->setGeometry(QRect(460, 60, 61, 20));
        barstrip2->setCheckable(false);
        barstrip4 = new QEPushButton(IdSerial);
        barstrip4->setObjectName(QStringLiteral("barstrip4"));
        barstrip4->setGeometry(QRect(460, 100, 61, 20));
        barstrip4->setCheckable(false);
        summary4 = new QEPushButton(IdSerial);
        summary4->setObjectName(QStringLiteral("summary4"));
        summary4->setGeometry(QRect(390, 100, 61, 20));
        summary4->setCheckable(false);
        summary6 = new QEPushButton(IdSerial);
        summary6->setObjectName(QStringLiteral("summary6"));
        summary6->setGeometry(QRect(390, 140, 61, 20));
        summary6->setCheckable(false);
        barstrip3 = new QEPushButton(IdSerial);
        barstrip3->setObjectName(QStringLiteral("barstrip3"));
        barstrip3->setGeometry(QRect(460, 80, 61, 20));
        barstrip3->setCheckable(false);
        barstrip5 = new QEPushButton(IdSerial);
        barstrip5->setObjectName(QStringLiteral("barstrip5"));
        barstrip5->setGeometry(QRect(460, 120, 61, 20));
        barstrip5->setCheckable(false);
        barscan = new QEPushButton(IdSerial);
        barscan->setObjectName(QStringLiteral("barscan"));
        barscan->setGeometry(QRect(540, 40, 121, 20));
        barscan->setCheckable(false);
        anascan = new QEPushButton(IdSerial);
        anascan->setObjectName(QStringLiteral("anascan"));
        anascan->setGeometry(QRect(540, 60, 121, 21));
        anascan->setCheckable(false);
        barstrip1 = new QEPushButton(IdSerial);
        barstrip1->setObjectName(QStringLiteral("barstrip1"));
        barstrip1->setGeometry(QRect(460, 40, 61, 20));
        barstrip1->setCheckable(false);
        summary2 = new QEPushButton(IdSerial);
        summary2->setObjectName(QStringLiteral("summary2"));
        summary2->setGeometry(QRect(390, 60, 61, 20));
        summary2->setCheckable(false);
        name1_7 = new QLabel(IdSerial);
        name1_7->setObjectName(QStringLiteral("name1_7"));
        name1_7->setGeometry(QRect(340, 10, 41, 21));
        sn_5 = new QELabel(IdSerial);
        sn_5->setObjectName(QStringLiteral("sn_5"));
        sn_5->setGeometry(QRect(160, 120, 101, 16));
        IMG_2 = new QEBitStatus(IdSerial);
        IMG_2->setObjectName(QStringLiteral("IMG_2"));
        IMG_2->setGeometry(QRect(350, 60, 21, 16));
        IMG_2->setNumberOfBits(1);
        IMG_2->setShape(QBitStatus::Circle);
        IMG_2->setInvalidColour(QColor(255, 0, 0));
        IMG_2->setOnColour(QColor(255, 0, 0));
        IMG_2->setOffColour(QColor(0, 255, 0));
        IMG_3 = new QEBitStatus(IdSerial);
        IMG_3->setObjectName(QStringLiteral("IMG_3"));
        IMG_3->setGeometry(QRect(350, 80, 21, 16));
        IMG_3->setNumberOfBits(1);
        IMG_3->setShape(QBitStatus::Circle);
        IMG_3->setInvalidColour(QColor(255, 0, 0));
        IMG_3->setOnColour(QColor(255, 0, 0));
        IMG_3->setOffColour(QColor(0, 255, 0));
        IMG_4 = new QEBitStatus(IdSerial);
        IMG_4->setObjectName(QStringLiteral("IMG_4"));
        IMG_4->setGeometry(QRect(350, 100, 21, 16));
        IMG_4->setNumberOfBits(1);
        IMG_4->setShape(QBitStatus::Circle);
        IMG_4->setInvalidColour(QColor(255, 0, 0));
        IMG_4->setOnColour(QColor(255, 0, 0));
        IMG_4->setOffColour(QColor(0, 255, 0));
        IMG_5 = new QEBitStatus(IdSerial);
        IMG_5->setObjectName(QStringLiteral("IMG_5"));
        IMG_5->setGeometry(QRect(350, 120, 21, 16));
        IMG_5->setNumberOfBits(1);
        IMG_5->setShape(QBitStatus::Circle);
        IMG_5->setInvalidColour(QColor(255, 0, 0));
        IMG_5->setOnColour(QColor(255, 0, 0));
        IMG_5->setOffColour(QColor(0, 255, 0));
        IMG_6 = new QEBitStatus(IdSerial);
        IMG_6->setObjectName(QStringLiteral("IMG_6"));
        IMG_6->setGeometry(QRect(350, 140, 21, 16));
        IMG_6->setNumberOfBits(1);
        IMG_6->setShape(QBitStatus::Circle);
        IMG_6->setInvalidColour(QColor(255, 0, 0));
        IMG_6->setOnColour(QColor(255, 0, 0));
        IMG_6->setOffColour(QColor(0, 255, 0));
        IMG_1 = new QEBitStatus(IdSerial);
        IMG_1->setObjectName(QStringLiteral("IMG_1"));
        IMG_1->setGeometry(QRect(350, 40, 21, 16));
        IMG_1->setNumberOfBits(1);
        IMG_1->setShape(QBitStatus::Circle);
        IMG_1->setInvalidColour(QColor(255, 0, 0));
        IMG_1->setOnColour(QColor(255, 0, 0));
        IMG_1->setOffColour(QColor(0, 255, 0));
    ...
    void retranslateUi(QMainWindow *mainWindow)
    {
        ...
        name1_7->setText(QApplication::translate("mainWindow", "Status:", 0));
        IMG_2->setProperty("variable", QVariant(QApplication::translate("mainWindow", "$(RGA1):ILK", 0)));
        IMG_3->setProperty("variable", QVariant(QApplication::translate("mainWindow", "$(RGA1):ILK", 0)));
        IMG_4->setProperty("variable", QVariant(QApplication::translate("mainWindow", "$(RGA1):ILK", 0)));
        IMG_5->setProperty("variable", QVariant(QApplication::translate("mainWindow", "$(RGA1):ILK", 0)));
        IMG_6->setProperty("variable", QVariant(QApplication::translate("mainWindow", "$(RGA1):ILK", 0)));
        IMG_1->setProperty("variable", QVariant(QApplication::translate("mainWindow", "$(RGA1):ILK", 0)));
    } // retranslateUi
