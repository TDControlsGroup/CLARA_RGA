...
#include "../../../calc/calculatorbuilder/calculatorform.h"
...
void CalculatorForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CalculatorForm *_t = static_cast<CalculatorForm *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject CalculatorForm::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CalculatorForm.data,
      qt_meta_data_CalculatorForm,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CalculatorForm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CalculatorForm.stringdata0))
        return static_cast<void*>(const_cast< CalculatorForm*>(this));
