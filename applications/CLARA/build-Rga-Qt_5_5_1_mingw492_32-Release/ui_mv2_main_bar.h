...
public:
    ...
    void retranslateUi(QMainWindow *mainBar)
    {
        ...
        qelabel_51->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M2.DESC", 0)));
        qelabel_51->setText(QApplication::translate("mainBar", "H2", 0));
        qelabel_53->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M4.DESC", 0)));
        qelabel_53->setText(QApplication::translate("mainBar", "HE", 0));
        qelabel_54->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M14.DESC", 0)));
        qelabel_54->setText(QApplication::translate("mainBar", "CH2/N2++", 0));
        qelabel_55->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M15.DESC", 0)));
        qelabel_55->setText(QApplication::translate("mainBar", "CH3", 0));
        qelabel_56->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M16.DESC", 0)));
        qelabel_56->setText(QApplication::translate("mainBar", "CH4", 0));
        qelabel_57->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M18.DESC", 0)));
        qelabel_57->setText(QApplication::translate("mainBar", "H2O", 0));
        qelabel_58->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M28.DESC", 0)));
        qelabel_58->setText(QApplication::translate("mainBar", "N2/CO", 0));
        qelabel_59->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M32.DESC", 0)));
        qelabel_59->setText(QApplication::translate("mainBar", "O2", 0));
        qelabel_109->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M40.DESC", 0)));
        qelabel_109->setText(QApplication::translate("mainBar", "AR", 0));
        qelabel_110->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M44.DESC", 0)));
        qelabel_110->setText(QApplication::translate("mainBar", "CO2", 0));
        qelabel_111->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M69.DESC", 0)));
        qelabel_111->setText(QApplication::translate("mainBar", "CF3/C5H9", 0));
        qelabel_112->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M2", 0)));
        qelabel_112->setText(QApplication::translate("mainBar", "4.599e-10 mbar", 0));
        qelabel_113->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M4", 0)));
        qelabel_113->setText(QApplication::translate("mainBar", "8.045e-11 mbar", 0));
        qelabel_114->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M14", 0)));
        qelabel_114->setText(QApplication::translate("mainBar", "5.282e-11 mbar", 0));
        qelabel_115->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M15", 0)));
        qelabel_115->setText(QApplication::translate("mainBar", "1.000e-14 mbar", 0));
        qelabel_116->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M16", 0)));
        qelabel_116->setText(QApplication::translate("mainBar", "1.000e-14 mbar", 0));
        qelabel_117->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M18", 0)));
        qelabel_117->setText(QApplication::translate("mainBar", "2.925e-11 mbar", 0));
        qelabel_118->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M28", 0)));
        qelabel_118->setText(QApplication::translate("mainBar", "2.032e-11 mbar", 0));
        qelabel_119->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M32", 0)));
        qelabel_119->setText(QApplication::translate("mainBar", "4.469e-11 mbar", 0));
        qelabel_120->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M40", 0)));
        qelabel_120->setText(QApplication::translate("mainBar", "1.000e-14 mbar", 0));
        qelabel_121->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M44", 0)));
        qelabel_121->setText(QApplication::translate("mainBar", "7.313e-12 mbar", 0));
        qelabel_122->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M69", 0)));
        qelabel_122->setText(QApplication::translate("mainBar", "1.000e-14 mbar", 0));
        qeanalogprogressbar_56->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M2", 0)));
        qeanalogprogressbar_56->setProperty("variableSubstitutions", QVariant(QString()));
        qeanalogprogressbar_57->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M4", 0)));
        qeanalogprogressbar_58->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M14", 0)));
        qeanalogprogressbar_59->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M15", 0)));
        qeanalogprogressbar_60->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M16", 0)));
        qeanalogprogressbar_61->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M18", 0)));
        qeanalogprogressbar_62->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M28", 0)));
        qeanalogprogressbar_63->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M32", 0)));
        qeanalogprogressbar_64->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M40", 0)));
        qeanalogprogressbar_65->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M44", 0)));
        qeanalogprogressbar_66->setProperty("variable", QVariant(QApplication::translate("mainBar", "$(CHD):BAR:M69", 0)));
    } // retranslateUi
