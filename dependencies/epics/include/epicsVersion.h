...
#define EPICS_VERSION_STRING "EPICS 3.15.3"
#define epicsReleaseVersion  "EPICS R3.15.3 $Date: Sun 2015-11-22 17:54:12 +0100$"

#define VERSION_INT(V,R,M,P) ( ((V)<<24) | ((R)<<16) | ((M)<<8) | (P))
#define EPICS_VERSION_INT VERSION_INT(3, 15, 3, 0)
